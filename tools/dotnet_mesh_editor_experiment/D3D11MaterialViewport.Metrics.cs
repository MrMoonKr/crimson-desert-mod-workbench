...
internal sealed partial class D3D11MaterialViewport
{
    ...
    public Dictionary<string, object?> LiveMetricsPayload()
    {
        var payload = new Dictionary<string, object?>
        {
            ...
            ["retained_overlay_buffer_creates"] = _retainedOverlayBufferCreateCount,
            ["retained_overlay_buffer_disposals"] = _retainedOverlayBufferDisposeCount,
            ["retained_wire_overlay_buffer_creates"] = _retainedWireOverlayBufferCreateCount,
            ["retained_wire_overlay_buffer_disposals"] = _retainedWireOverlayBufferDisposeCount,
            ["retained_overlay_buffer_maps"] = _retainedOverlayBufferMapCount,
            ["retained_overlay_buffer_no_overwrite_maps"] = _retainedOverlayBufferNoOverwriteMapCount,
            ["retained_overlay_buffer_bytes_estimate"] = RetainedOverlayBufferBytesEstimate(),
            ...
            ["device_identity"] = _device is null ? 0 : RuntimeHelpers.GetHashCode(_device),
