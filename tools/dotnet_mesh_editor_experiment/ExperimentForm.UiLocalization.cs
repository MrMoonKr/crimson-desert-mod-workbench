...
internal sealed partial class UiLocalizationOwner : IDisposable
{
    ...
    // BEGIN GENERATED UI LOCALIZATION KEYS
        ...
        "Bottom",
        "Bridge has no exact protected-record writeback route.",
        "Brush",
        "Brush Tools",
        ...
        "Create Part requires Faces selection mode.",
        "Create Part requires selected faces from exactly one source part.",
        "Create Profile...",
        ...
        "Created part '{value_0}' from {value_1} moved face(s).",
        "Ctrl + left-drag",
        ...
        "Duplicate",
        "Duplicate Selection",
        "Duplicate is unavailable because the exact PAC writer cannot add protected geometry records.",
        "Edge Split has no exact protected-record writeback route.",
        ...
        "Extrude has no exact protected-record writeback route.",
        "FPS -- | Frame -- ms",
        ...
        "Falloff",
        "Feather rings",
        "Fill has no exact protected-record writeback route.",
        "Finish Edit Mesh",
        ...
        "General",
        "Geometry layers that change topology have no exact PAC writeback route.",
        "Glow...",
        "Grab",
        "Grab radius",
        "Grid",
        ...
        "Ignored stale or uncorrelated resident interaction acknowledgement.",
        "Ignored stale or uncorrelated selection update.",
        "Imported / Modify (focus)",
        "Inflate",
        "Inset has no exact protected-record writeback route.",
        "Invert",
        "Lasso",
        ...
        "Mesh Editor Select could not start: {value_0}",
        "Mesh Editor edit was restored because sync could not start: {value_0}",
        "Mesh Editor gesture blocked: {value_0}.",
        "Mesh Editor gesture cancelled.",
        "Mesh Editor gesture cancelled: {value_0}.",
        "Mesh Editor gesture produced {value_0}.",
        "Mesh Editor interaction preparation failed: {value_0}",
        "Mesh Editor native interaction unavailable: {value_0}",
        "Mesh Editor {value_0} could not start: {value_1}",
        "Mesh edit sync retry failed: {value_0}",
        "Mesh edit sync was rejected: {value_0}. Restored the last durable state.",
        ...
        "Move selected Faces from one source part into a uniquely named appended part.",
        ...
        "Preparing indexed mesh interaction…",
        "Preview ",
        "Preview mode",
        ...
        "Rejected an out-of-order resident interaction acknowledgement.",
        "Rename",
        ...
        "Syncing edits…",
        "Syncing edits… Finish Edit Mesh will be available when the durable revision catches up.",
        "Syncing edits… Retrying the durable commit.",
        "Syncing edits… Save will be available when the durable revision catches up.",
        "Taper",
        "Texture",
        ...
        "Weld has no exact protected-record writeback route.",
        "Wheel",
        "Wire",
        "Wire + Vertices",
        "Wire overlay color",
        ...
        "{value_0} LOD{value_1} | {value_2} | exact: {value_3}",
        "{value_0} Preference save failed: {value_1}",
        "{value_0} active: left-drag inside the brush circle.",
        "{value_0} commands",
        "{value_0} is available only with a proven Free Edit OBJ output destination.",
