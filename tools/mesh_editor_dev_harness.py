...
_EXPORTS = {
    "_HarnessSignal": "tools.mesh_harness.native_protocol",
    "_NativeD3D11HarnessHost": "tools.mesh_harness.native_protocol",
    "_StandaloneStrokeHarnessHost": "tools.mesh_harness.native_protocol",
    ...
    "_close_process": "tools.mesh_harness.native_protocol",
    ...
    "_emit_timed_stroke": "tools.mesh_harness.native_projection",
    ...
    "_find_host_window": "tools.mesh_harness.native_protocol",
    "_finite_float": "tools.mesh_harness.native_projection",
    "_history_context_smoke": "tools.mesh_harness.service_selection",
    "_history_selection_smoke": "tools.mesh_harness.service_selection",
    "_host_window_rect": "tools.mesh_harness.native_protocol",
    ...
    "_matrix_only_screen_payload": "tools.mesh_harness.native_projection",
    ...
    "_payload_frame_count": "tools.mesh_harness.native_projection",
    "_place_host_window_on_screen1": "tools.mesh_harness.native_protocol",
    ...
    "_project_world_to_screen": "tools.mesh_harness.native_projection",
    "_projected_face_cluster_for_drag": "tools.mesh_harness.native_projection",
    ...
    "_screen_drag_for_z_delta": "tools.mesh_harness.native_projection",
    "_screen_source_transform_override_ok": "tools.mesh_harness.native_projection",
    ...
    "_send_json_command": "tools.mesh_harness.native_protocol",
    "_send_mouse_message": "tools.mesh_harness.native_protocol",
    ...
    "_timing_summary": "tools.mesh_harness.native_projection",
    ...
    "_wait_for_file": "tools.mesh_harness.native_protocol",
    "_wait_for_host_window": "tools.mesh_harness.native_protocol",
    "_wait_for_live_stroke_idle": "tools.mesh_harness.native_projection",
    "_wait_for_status": "tools.mesh_harness.native_protocol",
    ...
    "run_native_mesh_editor_d3d11_delta": "tools.mesh_harness.d3d_delta",
    ...
    "run_native_smoke": "tools.mesh_harness.native_smoke",
    ...
    "run_real_archive_mesh_editor_d3d11_edit_smoke": "tools.mesh_harness.real_d3d",
...
_EXPORTS.update(dict.fromkeys((
    ...
    "_HOST_CLASS", "_LEGACY_SCREEN_CAMERA_FIELDS", "_MK_LBUTTON", "_REAL_ARCHIVE_ANIMATION_PREFERRED_PAA",
    ...
    "_SYNTHETIC_D3D11_SCENARIOS", "_SYNTHETIC_MESH_FORMATS", "_WM_CLOSE", "_WM_COPYDATA",
    "_WM_COPYDATA_COMMAND", "_WM_LBUTTONDOWN", "_WM_LBUTTONUP", "_WM_MOUSEMOVE",
