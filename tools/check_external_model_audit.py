...
from cdmw.core.external_model_audit_check import (  # noqa: E402
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Check external_model_material_audit.json for external model material inventory evidence."
    )
    parser.add_argument("path", help="External model audit JSON path or directory containing external_model_material_audit.json.")
