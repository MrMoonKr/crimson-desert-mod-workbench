...
`--cdmw-session --embedded-parent-hwnd`; it is governed by
`cdmw_rust_mesh_editor_protocol_v1` and
`cdmw_rust_mesh_authoring_package_v1`, and has separate shadow-session, exact
output, Morph & Refit safety, atomic-history, packaging, HWND, and compiled v2
