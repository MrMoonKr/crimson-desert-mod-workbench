...
specular/gloss textures as classified but unsampled,
...
base-only, one-extra-role, factored-emissive, roughness-factor, metalness-factor,
metalness-plus-specular-factor, and fully composed CPU readbacks through the live
helper during its 34-frame pass. Every sampled role and each explicit factor class must change pixels independently. This is synthetic relationship
...
back material-role, emissive-factor, roughness-factor, metalness-factor,
metalness-plus-specular-factor, and fully composed probes: 34 frames total. The D3D12 validation scope was
