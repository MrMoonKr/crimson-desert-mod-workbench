...
class AlignmentDialogSourceGuardTests(unittest.TestCase):
    ...
    def test_alignment_dialog_has_native_d3d11_accurate_preview_mode(self) -> None:
        ...
        self.assertIn("legacy_preview_fallback_checkbox.setVisible(False)", source)
        ...
        self.assertIn("base_texture_defaults: bool = False", source)
        ...
        self.assertIn("preview_settings=preview_render_settings", source)
        self.assertIn("base_texture_defaults=True", source)
        self.assertIn("preview_render_settings = _alignment_lit_render_settings(", source)
        self.assertIn('aligned_settings.render_diagnostic_mode = "lit"', source)
        self.assertIn("aligned_settings.disable_tint = True", source)
        self.assertIn("aligned_settings.disable_brightness = True", source)
        self.assertIn("aligned_settings.disable_uv_scale = True", source)
    ...
    def test_alignment_dialog_sidecar_toggles_flow_into_preview_build(self) -> None:
        ...
        self.assertIn("neutralize_inherited_material_layers=bool(source_color_faithful_checkbox.isChecked())", source)
        self.assertIn("complete_external_material_reset=bool(external_material_reset_checkbox.isChecked())", source)
        ...
        self.assertNotIn("source_color_faithful_checkbox.isChecked() or _complete_external_swap_enabled()", source)
        self.assertNotIn("complete_external_material_reset=bool(_complete_external_swap_enabled())", source)
    ...
    def test_modify_original_clone_uses_exact_geometry_preview_and_target_highlight(self) -> None:
        ...
        self.assertIn('"Advanced Part Transform / Mesh Edit"', source)
        self.assertIn("advanced_part_tools_section.body_layout.addWidget(part_inspector)", source)
        self.assertIn("advanced_part_tools_section.body_layout.addWidget(mesh_edit_group)", source)
    ...
    def test_model_preview_draws_selected_part_outline_overlay(self) -> None:
        ...
        self.assertIn("def _alignment_rotation_handle_at", source)
        self.assertIn("rotation_handle = self._alignment_rotation_handle_at(event.position())", source)
        self.assertIn('self._alignment_rotation_drag_roll = rotation_handle == "roll"', source)
    ...
    def test_alignment_d3d11_gizmo_defaults_to_whole_replacement_mesh(self) -> None:
        ...
        self.assertIn("editor_role_key = editor_role.lower()", widgets_source)
        self.assertIn('"replacement" in editor_role_key', widgets_source)
        self.assertIn("editor_editable=editor_editable", widgets_source)
    ...
    def test_alignment_dialog_routes_visible_dds_contract_and_prune_intent(self) -> None:
        ...
        self.assertIn("prune_unmapped_original_texture_parameters=bool(\n                        prune_unmapped_original_dds_checkbox.isChecked()", source)
        self.assertNotIn("prune_unmapped_original_dds_checkbox.isChecked() or _complete_external_swap_enabled()", source)
        self.assertNotIn("source_color_faithful_checkbox.setChecked(True)", source)
    ...
    def test_modify_original_replacement_copies_direct_dds_bindings(self) -> None:
        ...
        self.assertIn("setattr(dst_mesh, attr, copy.deepcopy(getattr(src_mesh, attr)))", source)
    ...
    def test_modify_original_gizmo_and_empty_texture_panel_are_compact(self) -> None:
        ...
        self.assertIn("axis_extent = 0.95", widgets_source)
        self.assertIn("best_distance = 30.0", widgets_source)
        self.assertIn("painter.drawEllipse(end, radius, radius)", widgets_source)
