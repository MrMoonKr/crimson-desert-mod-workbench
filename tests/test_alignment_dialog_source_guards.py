...
class AlignmentDialogSourceGuardTests(unittest.TestCase):
    ...
    def test_modify_original_clone_uses_exact_geometry_preview_and_target_highlight(self) -> None:
        ...
        self.assertIn("mesh_edit_layout_page.addWidget(mesh_edit_group, 0, Qt.AlignLeft | Qt.AlignTop)", source)
    ...
    def test_alignment_dialog_has_obj_mesh_edit_controls_and_revision_hooks(self) -> None:
        ...
        self.assertIn('mesh_edit_group = QGroupBox("Mesh Editing")', main_source)
    ...
    def test_alignment_geometry_tab_uses_compact_source_parts_master_list(self) -> None:
        ...
        self.assertIn("mesh_edit_group.setSizePolicy(QSizePolicy.Fixed, QSizePolicy.Maximum)", source)
        self.assertIn("mesh_edit_group.setMaximumWidth(mesh_edit_control_content_min_width)", source)
