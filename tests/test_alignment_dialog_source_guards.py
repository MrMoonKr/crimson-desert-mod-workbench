...
class AlignmentDialogSourceGuardTests(unittest.TestCase):
    ...
    def test_mesh_editor_embeds_same_alignment_preview_builder(self) -> None:
        ...
        self.assertIn("embedded_alignment_builder = False", source)
        ...
        self.assertIn("control_width = max(380, min(620, int(normalized_width * 0.40)))", layout_state_source)
        self.assertIn("max(220, normalized_width - control_width)", layout_state_source)
        ...
        self.assertNotIn("self.mesh_editor_tab.mount_embedded_builder(dialog)", source)
        self.assertIn("_fit_alignment_dialog_to_screen()", source)
        self.assertIn("dialog.raise_()", source)
        self.assertNotIn("embedded_host=self.mesh_editor_tab.builder_host() if hasattr(self, \"mesh_editor_tab\") else None", source)
    ...
    def test_alignment_dialog_has_native_d3d11_accurate_preview_mode(self) -> None:
        ...
        self.assertIn('"settings_button": "Lighting / Texture Settings..."', preview_status_source)
        self.assertIn("Mesh Replacement Alignment renderer and texture controls are available from Lighting / Texture Settings.", preview_status_source)
        ...
        self.assertIn("_set_preview_performance_status(timing_presentation.summary, details=timing_presentation.details)", source)
    ...
    def test_modify_original_clone_uses_exact_geometry_preview_and_target_highlight(self) -> None:
        ...
        self.assertIn('"advanced_part_transform": "Advanced Part Transform"', mapping_table_state_source)
    ...
    def test_alignment_dialog_has_obj_mesh_edit_controls_and_revision_hooks(self) -> None:
        ...
        self.assertIn('mesh_edit_enabled_checkbox = QCheckBox(mesh_edit_action_control_text["edit_mode"])', main_source)
        self.assertIn('"edit_mode": "Edit Mode"', main_source)
        ...
        self.assertIn("_alignment_mesh_edit_tab_active = lambda", main_source)
        ...
        self.assertIn("restore_deleted_output = _mesh_edit_should_restore_deleted_output_helper(", main_source)
        ...
        self.assertIn("group.get(payload_index_key)", main_source)
        ...
        self.assertIn("source_face_index", native_source)
    ...
    def test_alignment_dialog_can_append_mesh_parts_in_geometry(self) -> None:
        ...
        self.assertIn("mapped_preview_source_indices = _mapped_source_indices(current_mappings)", source)
    ...
    def test_alignment_geometry_tab_uses_compact_source_parts_master_list(self) -> None:
        ...
        self.assertIn('"advanced_part_transform": "Advanced Part Transform"', mapping_table_state_source)
        self.assertIn("advanced_part_tools_section = CollapsibleSection(", source)
        self.assertIn('mapping_table_action_control_text["advanced_part_transform"]', source)
        ...
        self.assertIn("original_parts_label.setVisible(visibility_state.advanced_visible)", source)
        self.assertIn("source_parts_group.setVisible(visibility_state.advanced_visible)", source)
    ...
    def test_parts_outliner_has_click_edit_contract_and_copied_part_safety(self) -> None:
        ...
        self.assertIn("_refresh_source_assignment_columns(lightweight=True)", source_role_block)
        ...
        self.assertIn("_set_source_role_override_value(action_state.source_index, action_state.normalized_role)", source_role_block)
    ...
    def test_alignment_transform_preview_uses_fast_path_without_settled_rebuild(self) -> None:
        ...
        self.assertIn('if bool(preview_queue_state["start_timer"]):', update_block)
    ...
    def test_alignment_texture_uv_refresh_skips_slow_settle_debounce(self) -> None:
        ...
        fast_flip_end = source.index("_alignment_geometry_tab_active = lambda", fast_flip_start)
    ...
    def test_alignment_fast_preview_does_not_replace_export_options(self) -> None:
        ...
        self.assertIn("float(rotate_x_spin.value())", source)
        self.assertIn("offset_xyz=(", source)
        self.assertIn("float(offset_x_spin.value())", source)
    ...
    def test_texture_plan_has_single_bulk_apply_action(self) -> None:
        ...
        part_mapped_end = source.index("def _refresh_selected_part_copied_texture_controls", part_mapped_start)
        ...
        self.assertIn("mesh.preview_texture_flip_vertical = False", source)
        self.assertNotIn("mesh.preview_texture_flip_vertical = scene_import_normalizes_texture_v", source)
        self.assertNotIn("from cdmw.core.model_preview_orientation import scene_import_normalizes_texture_v", source)
        added_part_textures_source = ARCHIVE_STATIC_REPLACEMENT_ADDED_PART_TEXTURES.read_text(encoding="utf-8")
    ...
    def test_alignment_dialog_routes_visible_dds_contract_and_prune_intent(self) -> None:
        ...
        self.assertIn("reason=_material_authority_complete_swap_routing_reason_helper(),", complete_apply_block)
        self.assertIn(
    ...
    def test_manual_material_profile_exposes_runtime_controls_under_combo(self) -> None:
        ...
        self.assertIn('("scratch_roughness", "_scratchRoughness")', source)
        self.assertIn('("scratch_metallic", "_scratchMetallic")', source)
        self.assertIn('("shine_scalar", "_specularAmount")', source)
    ...
    def test_mesh_editor_source_preview_preserves_spec_gloss_and_full_direct_geometry(self) -> None:
        ...
        self.assertIn('normalized_mode == "replacement_only"', static_preview_state_source)
        self.assertIn('normalized_mode in {"side_by_side", "replacement_only"}', static_preview_state_source)
        self.assertIn(
    ...
    def test_mesh_editor_parts_delete_requires_apply_and_unassigns_routes(self) -> None:
        ...
        self.assertIn("preserved_multi_indices = _source_tree_context_selection_multi_indices_helper(", menu_helper)
        self.assertIn("_source_tree_context_menu_selection_state_helper(", menu_helper)
    ...
    def test_alignment_direct_source_preview_applies_imported_texture_sets(self) -> None:
        source = _main_window_source()
        preview_textures_source = ARCHIVE_STATIC_REPLACEMENT_PREVIEW_TEXTURES.read_text(encoding="utf-8")
        self.assertIn("if state.texture_sets and (not use_original_material_preview) and (not mesh_edit_direct_source_preview):", source)
