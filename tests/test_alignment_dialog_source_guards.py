...
class AlignmentDialogSourceGuardTests(unittest.TestCase):
    ...
    def test_alignment_dialog_has_in_memory_test_build_preview(self) -> None:
        ...
        self.assertIn("Live alignment preview - normal quality; geometry/materials approximated for editing.", source)
    ...
    def test_alignment_dialog_has_native_d3d11_accurate_preview_mode(self) -> None:
        ...
        self.assertIn('return clamp_model_preview_render_settings(fast_settings), False, False, "normal"', source)
    ...
    def test_alignment_d3d11_preview_reuses_cached_packages_for_live_changes(self) -> None:
        ...
        self.assertIn("D3D11 preview waiting for first frame", source)
    ...
    def test_alignment_normal_quality_is_fast_biased_and_startup_steps_are_timed(self) -> None:
        source = _main_window_source()
        ...
        self.assertIn('str(label or "").strip().casefold() == "final test build preview"', accurate_body)
        self.assertIn("return True", accurate_body)
        self.assertIn("return False", accurate_body)
        self.assertNotIn("return not _alignment_auto_detail_uses_fast_package(label, model)", accurate_body)
        self.assertIn("target_total_faces=35_000", source)
        self.assertNotIn('if _alignment_preview_detail_mode() == "full":\n                            return 0', source)
