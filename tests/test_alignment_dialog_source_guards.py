...
class AlignmentDialogSourceGuardTests(unittest.TestCase):
    ...
    def test_global_gloss_reduction_slider_is_wired_to_static_options(self) -> None:
        ...
        self.assertIn("Extra matte fallback", source)
        self.assertIn("Extra fallback matte control", source)
        ...
        self.assertIn("Material Authority already bypasses the glossy color-blend mask", source)
        self.assertIn("global_gloss_reduction: float = 0.0", static_source)
        self.assertIn("global_gloss_reduction=max(0.0, min(100.0, float(global_gloss_reduction or 0.0)))", source)
    ...
    def test_true_source_basic_controls_are_wired_to_static_options(self) -> None:
        ...
        self.assertNotIn("MeshAlignmentToneContrastSlider", source)
        self.assertNotIn("Lift black detail", source)
        self.assertNotIn("Tone / contrast", source)
        ...
        self.assertIn("tone_contrast=0.0", source)
