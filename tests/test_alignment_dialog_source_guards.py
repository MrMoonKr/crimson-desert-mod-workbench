...
class AlignmentDialogSourceGuardTests(unittest.TestCase):
    ...
    def test_alignment_dialog_build_mod_keeps_window_open_for_repeat_exports(self) -> None:
        ...
        self.assertIn('patch_game_files_button = QPushButton("Patch Game Files")', source)
        self.assertIn("Directly patch the rebuilt mesh into scanned game archives for testing.", source)
        self.assertIn(
        ...
        self.assertIn("Started mesh replacement archive patch. Builder window remains open for more edits.", source)
    ...
    def test_mesh_replacement_direct_archive_patch_flow_is_explicit_and_backed_up(self) -> None:
        ...
        self.assertIn("Final package texture preflight found direct archive patch warning(s)", source)
        self.assertIn("continuing because Patch Game Files only writes existing archive entries", source)
