...
class AlignmentDialogSourceGuardTests(unittest.TestCase):
    ...
    def test_alignment_dialog_is_maximizable_and_keeps_controls_readable(self) -> None:
        ...
        self.assertIn("mesh_edit_control_min_width = 300", source)
        self.assertIn("mesh_edit_control_content_min_width = 320", source)
        ...
        self.assertIn("controls_panel.setMaximumWidth(460 if mesh_edit_tools_active else 16777215)", source)
        self.assertIn("control_width = max(mesh_edit_control_min_width, min(420, int(width * 0.18)))", source)
    ...
    def test_alignment_geometry_tab_uses_compact_source_parts_master_list(self) -> None:
        ...
        self.assertIn("mesh_edit_layout.setColumnMinimumWidth(0, 82)", source)
        self.assertIn("mesh_edit_layout.addWidget(mesh_edit_tool_combo, 2, 1)", source)
        self.assertIn("mesh_edit_layout_page.addWidget(mesh_edit_group, 0)", source)
