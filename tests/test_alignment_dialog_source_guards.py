...
class AlignmentDialogSourceGuardTests(unittest.TestCase):
    ...
    def test_alignment_dialog_has_obj_mesh_edit_controls_and_revision_hooks(self) -> None:
        ...
        self.assertIn("if restore_deleted_output_by_source.get(source_index):", main_source)
        ...
        self.assertIn("allow_python_full_mesh_clone_fallback(", reset_scope)
        self.assertIn("if restore_deleted_output_by_source.get(source_index):", reset_scope)
        self.assertIn("adjustment = _ensure_source_part_adjustment(source_index)", reset_scope)
