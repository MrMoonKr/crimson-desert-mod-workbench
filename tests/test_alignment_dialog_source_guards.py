...
class AlignmentDialogSourceGuardTests(unittest.TestCase):
    ...
    def test_alignment_dialog_has_source_mixing_tray_without_new_top_level_tab(self) -> None:
        ...
        self.assertIn('summary_section = CollapsibleSection("Options", expanded=False)', source)
        ...
        self.assertNotIn('CollapsibleSection("Advanced"', workflow_source)
        self.assertIn("advanced_setup_section = QWidget(setup_page)", workflow_source)
        ...
        self.assertIn("source_mix_section.body_layout.addWidget(source_mix_tray)", source)
        ...
        self.assertIn("_state.transform_section.body_layout.insertWidget(0, _state.transform_group)", ui_source)
        self.assertNotIn("_state.setup_layout.addWidget(_state.advanced_setup_section)", ui_source)
    ...
    def test_modify_original_clone_uses_exact_geometry_preview_and_target_highlight(self) -> None:
        ...
        self.assertIn("'Transform and Parts'", source)
        ...
        self.assertIn("_state.setup_layout.insertWidget(1, _state.advanced_part_tools_section)", source)
    ...
    def test_alignment_drag_commits_final_release_delta_before_clearing_live_transform(self) -> None:
        ...
        self.assertIn('placement.get(key', host_source)
    ...
    def test_parts_outliner_has_click_edit_contract_and_copied_part_safety(self) -> None:
        ...
        authority_controls_source = ARCHIVE_STATIC_REPLACEMENT_MATERIAL_AUTHORITY_CONTROLS.read_text(encoding="utf-8")
        # Glow moved out of Material Authority: Part Setup owns it per part. Owner's decision, 2026-08-17.
        self.assertNotIn("addLayout(_state.part_glow_color_row", source)
        self.assertNotIn("addLayout(_state.accent_glow_row", source)
    ...
    def test_alignment_texture_uv_refresh_skips_slow_settle_debounce(self) -> None:
        ...
        self.assertIn("if _state.context.get('embedded_alignment_builder'):", queue_block)
    ...
    def test_alignment_d3d11_preview_reuses_cached_packages_for_live_changes(self) -> None:
        ...
        self.assertIn("_safe_start_alignment_timer(_state.alignment_d3d11_reload_timer)", queue_block)
    ...
    def test_in_game_mesh_swap_backend_is_retained_but_normal_ui_is_archived(self) -> None:
        ...
        self.assertIn("complete_swap_scope_default = not preserve_source_contract_default", source)
        ...
        self.assertIn("Donor material contract detected", source)
        self.assertIn("Defaulting to Select Item Family instead of Complete In-Game Swap", source)
    ...
    def test_mesh_import_setup_dialog_is_compact(self) -> None:
        ...
        self.assertIn("dialog.setMinimumSize(640, 300)", source)
        self.assertIn('CollapsibleSection("Files", expanded=False)', source)
        self.assertIn('CollapsibleSection("Details", expanded=False)', source)
        mesh_import_setup_source = ARCHIVE_MESH_IMPORT_SETUP_STATE.read_text(encoding="utf-8")
