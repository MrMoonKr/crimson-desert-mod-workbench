...
class AlignmentDialogSourceGuardTests(unittest.TestCase):
    ...
    def test_mesh_editor_opens_alignment_builder_embedded_when_host_available(self) -> None:
        ...
        self.assertIn("control_width = max(360, min(540, int(normalized_width * 0.30)))", layout_state_source)
    ...
    def test_modify_original_clone_uses_exact_geometry_preview_and_target_highlight(self) -> None:
        ...
        self.assertIn("edges.update((_edge(face[0], face[1]), _edge(face[1], face[2]), _edge(face[2], face[0])))", mesh_edit_callback_source)
        self.assertIn("if left in vertices and right in vertices:", mesh_edit_callback_source)
