...
class ArchiveBrowserAssetUnderstandingUiSourceGuards(unittest.TestCase):
    ...
    def test_archive_file_context_menu_exposes_role_aware_actions(self) -> None:
        ...
        self.assertNotIn('"Edit HKX..."', actions_source)
        self.assertNotIn('"Physics / HKX"', actions_source)
        self.assertNotIn('"Export HKX JSON..."', actions_source)
        self.assertNotIn('"Export HKX XML..."', actions_source)
        self.assertNotIn('"Export Havok XML View..."', actions_source)
        ...
        self.assertIn("chosen_action = menu.exec", actions_source)
        self.assertIn("self._queue_archive_mesh_editor_context_launch(entry)", actions_source)
        self.assertNotIn("open_mesh_editor_action.triggered.connect", actions_source)
    ...
    def test_material_values_preview_uses_embedded_vortice_renderer(self) -> None:
        ...
        self.assertIn("reused active Archive Browser Preview package; no material values changed.", source)
    ...
    def test_composite_appearance_preview_action_is_present(self) -> None:
        ...
        self.assertIn("Preparing composite appearance preview for Preview", source)
    ...
    def test_mod_generation_ui_uses_target_manager_checklists(self) -> None:
        ...
        self.assertIn("Preview-only socket selection", source)
        ...
        self.assertIn("Preview placement preview is available.", source)
