...
class CrashReportingGuardTests(unittest.TestCase):
    ...
    def test_crimson_desert_theme_is_available(self) -> None:
        ...
        self.assertIn('"accent": "#c67046"', source)
    ...
    def test_compact_screens_scale_controls_not_only_splitters(self) -> None:
        ...
        self.assertIn("base_font_size = configured_base_font_size", shell_theme_source)
        self.assertIn("data_font_size = configured_data_font_size", shell_theme_source)
        self.assertNotIn("configured_base_font_size * screen_scale", shell_theme_source)
        self.assertNotIn("configured_data_font_size * screen_scale", shell_theme_source)
