...
class ModPackageRetrofitTests(unittest.TestCase):
    ...
    def test_ui_source_exposes_dialog_and_uses_retrofit_helper(self) -> None:
        ...
        self.assertIn("Scan loose or zipped mod packages", source)
        self.assertIn("Preview Package Plan", source)
        self.assertIn("Package plan preview", source)
        self.assertIn("Package status", source)
        ...
        self.assertNotIn("Refresh Game Index", source)
        self.assertNotIn("Game build", source)
        self.assertNotIn("current game", source)
        self.assertNotIn("game version", source)
        self.assertNotIn("Game-file compare", source)
        self.assertNotIn("archive index", source)
        self.assertNotIn("Update plan preview", source)
        self.assertNotIn("Preview Update Plan", source)
