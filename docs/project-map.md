...
| Asset authoring helpers | `cdmw/services/asset_authoring_service.py`, `cdmw/workers/asset_authoring_workers.py` | `cdmw/ui/texture_workflow/asset_authoring_panel.py`, `native/cdmw_mesh_core/` | `tests/test_asset_authoring_*.py`, asset-authoring harness scenarios | `docs/features/asset-authoring-integrations.md`, `docs/plans/active/asset-authoring-integrations.md` |
