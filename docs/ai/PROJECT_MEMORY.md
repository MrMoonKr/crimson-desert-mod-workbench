...
- Qualify that historical 120/0/0 as renderer-to-renderer evidence for prepared packages, not PAC-source fidelity. Source-fidelity proof separately requires exact PAC XML wrapper/owner/parameter and DDS-binding conservation through Modify Original, initial packaging, and resident delivery, plus direct full-model and every-visible-submesh review. Semantic green or initial/resident signature equality cannot override broken geometry or a wrong visible region; the active equipment-first follow-up remains incomplete until its fresh capture and direct region verdicts finish.
