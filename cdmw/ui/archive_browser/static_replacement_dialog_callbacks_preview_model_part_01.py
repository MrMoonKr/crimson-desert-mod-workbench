...
def _preview_model_step_015(_state):
    ...
    def _current_dialog_mappings_for_preview() -> List[StaticSubmeshMapping]:
        ...
        render_source_indices = set(_state._source_renderable_indices_helper(_state.replacement_mesh_for_mapping, _state.source_part_adjustments, is_marker_source=_state._is_marker_source))
