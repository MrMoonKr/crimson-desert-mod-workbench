...
def create_alignment_setup_options_transform_section(context: dict[str, object]) -> SimpleNamespace:
    ...
    setup_texture_flip_controls_in_preview = bool(setup_texture_flip_u_checkbox and setup_texture_flip_v_checkbox)
    if setup_texture_flip_u_checkbox is None:
    ...
    setup_texture_flip_u_checkbox.setText(texture_uv_control_text["flip_u_label"])
    setup_texture_flip_u_checkbox.setToolTip(texture_uv_control_text["setup_flip_u_tooltip"])
    if setup_texture_flip_v_checkbox is None:
    ...
    setup_texture_flip_v_checkbox.setText(texture_uv_control_text["flip_v_label"])
    ...
    if not setup_texture_flip_controls_in_preview:
    ...
    if full_import_model_replacement:
        ...
        manual_profile_group.setVisible(False)
        setup_texture_flip_u_checkbox.setVisible(False)
        setup_texture_flip_v_checkbox.setVisible(False)
