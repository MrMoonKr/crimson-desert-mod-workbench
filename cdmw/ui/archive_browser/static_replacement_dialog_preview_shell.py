...
def create_alignment_preview_shell_section(context: dict[str, object]) -> SimpleNamespace:
    ...
    preview_render_controls.addWidget(QLabel(alignment_preview_render_control_text["visible_label"]))
    preview_render_controls.addWidget(preview_visible_mode_combo, 1)
    preview_render_controls.addWidget(QLabel(alignment_preview_render_control_text["render_label"]))
    preview_render_controls.addWidget(preview_render_mode_combo, 1)
