...
class ArchiveControlsPanelMixin:
    ...
    def _build_archive_controls_panel(self, pump_startup_splash: Callable[[str], None]) -> None:
        ...
        archive_controls_min, _archive_controls_pref, archive_controls_max = self.shell._archive_controls_sidebar_bounds()
        ...
        self._build_archive_location_controls()
        ...
        self.archive_log_highlighter = LogHighlighter(self.archive_log_view.document(), self.shell.current_theme_key)
        ...
        self.archive_filters_group = archive_filters_group
        ...
        self.textures._add_combo_choice(self.archive_role_filter_combo, "All roles", "all")
        self.textures._add_combo_choice(self.archive_role_filter_combo, "Textures", "texture")
        self.textures._add_combo_choice(self.archive_role_filter_combo, "Base / likely albedo images", "image")
        self.textures._add_combo_choice(self.archive_role_filter_combo, "Normal maps", "normal")
        self.textures._add_combo_choice(self.archive_role_filter_combo, "Material / mask", "material")
        self.textures._add_combo_choice(self.archive_role_filter_combo, "Impostor", "impostor")
        self.textures._add_combo_choice(self.archive_role_filter_combo, "UI", "ui")
        self.textures._add_combo_choice(self.archive_role_filter_combo, "Text", "text")
        ...
        self.textures._add_combo_choice(self.archive_browser_view_mode_combo, "Folders", "folders")
        self.textures._add_combo_choice(self.archive_browser_view_mode_combo, "Categories", "categories")
        self.textures._add_combo_choice(self.archive_browser_view_mode_combo, "Categories + Folders", "categories_folders")
        self.textures._add_combo_choice(self.archive_browser_view_mode_combo, "Flat", "flat")
        ...
        self.archive_actions_group = archive_actions_group
    ...
    def _build_archive_location_controls(self) -> None:
        ...
        self.archive_package_root_browse_button.clicked.connect(self.shell._browse_archive_package_root)
        ...
        self.archive_extract_root_browse_button.clicked.connect(self.shell._browse_archive_extract_root)
