...
_CONTEXT_NAMES = (
    ...
    '_mesh_edit_topology_source_indices_helper', '_mesh_edit_triangle_replace_groups_helper', '_mesh_edit_vector3_or_zero_helper', '_morph_slider_active_deltas_helper', '_morph_slider_add_target_action_text_helper',
    '_morph_slider_add_target_route_state_helper', '_morph_slider_added_status_text_helper', '_morph_slider_amount_prompt_text_helper', '_morph_slider_bake_state_helper', '_morph_slider_capture_post_edit_deltas_helper',
    ...
    '_morph_slider_expected_vertex_counts_helper', '_morph_slider_feather_prompt_text_helper', '_morph_slider_has_loaded_deltas_helper', '_morph_slider_has_nonzero_values_helper', '_morph_slider_import_action_text_helper',
    '_morph_slider_import_route_state_helper', '_morph_slider_imported_status_text_helper', '_morph_slider_name_prompt_text_helper', '_morph_slider_post_edit_deltas_need_reset_helper', '_morph_slider_reload_state_helper',
    ...
    '_morph_slider_target_mesh_file_filter_helper', '_morph_slider_topology_changed_reason_text_helper', '_morph_slider_unique_slider_id_helper', '_morph_slider_value_commit_state_helper', '_morph_slider_value_or_default_helper',
    ...
    'modify_original_clone_mode', 'morph_slider_add_action', 'morph_slider_bake_button', 'morph_slider_change_active', 'morph_slider_create_button',
    'morph_slider_deltas', 'morph_slider_group', 'morph_slider_import_action', 'morph_slider_manage_button', 'morph_slider_post_edit_deltas',
