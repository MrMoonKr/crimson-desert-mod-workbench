...
def mesh_editor_action_icon(icon_key: str, palette: QPalette | None = None) -> QIcon:
    ...
    if key.startswith("select_vertex"):
        ...
        painter.setBrush(Qt.NoBrush)
        painter.setPen(pen(accent, 1.7))
        painter.drawLine(4, 10, 8, 10)
        painter.drawLine(8, 10, 6, 8)
        painter.drawLine(8, 10, 6, 12)
        painter.drawLine(16, 10, 12, 10)
        painter.drawLine(12, 10, 14, 8)
        painter.drawLine(12, 10, 14, 12)
        painter.drawLine(10, 4, 10, 8)
        painter.drawLine(10, 8, 8, 6)
        painter.drawLine(10, 8, 12, 6)
        painter.drawLine(10, 16, 10, 12)
        painter.drawLine(10, 12, 8, 14)
        painter.drawLine(10, 12, 12, 14)
    elif key == "delete":
        ...
        painter.setPen(pen(accent, 1.3))
        painter.drawLine(10, 5, 10, 14)
        painter.drawLine(4, 9, 16, 9)
        painter.setPen(pen(primary, 1.7))
        ...
        left = _triangle_path()
        left.translate(-3, 0)
        right = _triangle_path()
        right.translate(3, 0)
        painter.drawPath(left)
        painter.drawPath(right)
        painter.setPen(pen(accent, 1.6))
        painter.drawLine(10, 5, 10, 15)
    elif key == "recalculate_normals":
        painter.drawPath(_triangle_path())
        painter.setPen(pen(accent, 1.7))
        painter.drawLine(10, 11, 10, 3)
        painter.drawLine(10, 3, 8, 5)
        painter.drawLine(10, 3, 12, 5)
    elif key == "weighted_normals":
        painter.setPen(pen(primary, 1.5))
        painter.drawPath(_triangle_path())
        painter.setPen(pen(accent, 2.8))
        ...
        painter.drawPath(_triangle_path())
        painter.setPen(pen(accent, 1.6))
        painter.drawLine(7, 4, 7, 11)
        painter.drawLine(7, 11, 5, 9)
        painter.drawLine(7, 11, 9, 9)
