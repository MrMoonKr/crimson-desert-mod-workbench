...
from cdmw.ui.mesh_editor.tab_selection_payloads import (
    MeshEditorSelectionPayloadMixin,
)



class MeshEditorDotNetPayloadMixin(MeshEditorDotNetMaterialParameterMixin, MeshEditorSelectionPayloadMixin):
