        ...
        *,
        ...
        def _add_performance_row(
            ...
            *,
            ...
            row_layout.addWidget(control, 1, 0, alignment=Qt.AlignLeft | Qt.AlignTop)
            note_widget = _performance_note(note)
            row_layout.addWidget(note_widget, 2, 0)
        ...
        performance_overview.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        ...
        performance_content.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        ...
        performance_grid_widget.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        performance_grid = WrappingLayout(performance_grid_widget, columns=2)
        performance_grid.setContentsMargins(0, 0, 0, 0)
        performance_grid.setSpacing(14)
        ...
        self.archive_native_preview_cache_mode_combo.setToolTip(
            "Durable Preview .pac preview package cache on disk. Balanced keeps up to 512 MB of packages and 192 MB of decoded textures. Aggressive raises those to 2 GB and 512 MB, so previews you return to stay warm for longer. Off rebuilds every preview and clears what earlier modes wrote."
        )
        preview_cache_row = _add_performance_row(
            preview_cache_layout,
            preview_cache_row,
        ...
        performance_grid.addWidget(workload_group)
        performance_grid.addWidget(archive_list_group)
        performance_grid.addWidget(related_index_group)
        performance_grid.addWidget(preview_cache_group)
        ...
        performance_host.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        ...
        performance_host_layout.addWidget(performance_content, stretch=50)
        performance_host_layout.addStretch(1)
        ...
        preview_layout.addRow("Preview view", self.d3d11_view_mode_combo)
        ...
        preview_layout.addRow("Preview normal Y", self.d3d11_normal_y_mode_combo)
        ...
        preview_layout.addRow("Preview texture address", self.d3d11_texture_address_mode_combo)
        ...
        self.d3d11_cull_back_faces_checkbox = QCheckBox("Preview cull back faces")
        for checkbox in (
        ...
        shading_layout.addRow("Preview mip LOD bias", self.d3d11_mip_lod_bias_spin)
        ...
        shading_layout.addRow("Preview light azimuth", self.d3d11_light_azimuth_spin)
        ...
        shading_layout.addRow("Preview light elevation", self.d3d11_light_elevation_spin)
        ...
        shading_layout.addRow("Preview AO strength", self.d3d11_ao_strength_spin)
        ...
        shading_layout.addRow("Preview roughness bias", self.d3d11_roughness_bias_spin)
        ...
        shading_layout.addRow("Preview metalness scale", self.d3d11_metalness_scale_spin)
        ...
        shading_layout.addRow("Preview environment strength", self.d3d11_environment_strength_spin)
        ...
        shading_layout.addRow("Preview emissive gain", self.d3d11_emissive_gain_spin)
        ...
        shading_layout.addRow("Preview tone exposure", self.d3d11_tone_exposure_spin)
        ...
        shading_layout.addRow("Preview tone contrast", self.d3d11_tone_contrast_spin)
        ...
        shading_layout.addRow("Preview tone gamma", self.d3d11_tone_gamma_spin)
