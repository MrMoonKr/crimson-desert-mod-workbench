        ...
        return [
            ...
            },
            {
                ...
                <table>
                  ...
                  <tr><td>Edit Material Values</td><td>The selected mesh has a recognized XML/material sidecar.</td><td>Opens an isolated, screen-aware editor that can be maximized. Parameters provides typed controls and undo/reset; Connections navigates current-index and Asset Family evidence without scanning or changing the browser selection; Source &amp; Changes shows read-only, line-numbered XML with syntax colors and red/green unified diffs. Export writes a mod-ready package while preserving the source encoding and untouched XML bytes.</td></tr>
                </table>
