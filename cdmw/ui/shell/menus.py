...
class ShellMenusMixin:
    ...
    def _build_shell_menus(self) -> None:
        ...
        self.archive.archive_scan_progress_label = QLabel("Ready")
        self.archive.archive_scan_progress_label.setObjectName("HintLabel")
        self.archive.archive_scan_progress_label.setMinimumHeight(26)
        self.archive.archive_scan_progress_label.setFixedWidth(110)
        self.archive.archive_scan_progress_label.setAlignment(Qt.AlignRight | Qt.AlignVCenter)
        self.archive.archive_scan_progress_label.setSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        self.archive.archive_scan_progress_label.setToolTip("Ready to scan archive indexes.")
        self.archive.archive_scan_progress_bar = QProgressBar()
        self.archive.archive_scan_progress_bar.setRange(0, 100)
        self.archive.archive_scan_progress_bar.setValue(0)
        self.archive.archive_scan_progress_bar.setTextVisible(True)
        self.archive.archive_scan_progress_bar.setFormat("0%")
        self.archive.archive_scan_progress_bar.setFixedSize(118, 18)
        self.archive.archive_scan_progress_bar.setToolTip("Ready to scan archive indexes.")
        self.archive.archive_cache_status_chip = QLabel("Cache: Unknown")
        self.archive.archive_cache_status_chip.setObjectName("ArchiveCacheStatusChip")
        self.archive.archive_cache_status_chip.setMinimumHeight(26)
        self.archive.archive_cache_status_chip.setFixedWidth(132)
        self.archive.archive_cache_status_chip.setAlignment(Qt.AlignCenter)
        self.archive.archive_cache_status_chip.setSizePolicy(QSizePolicy.Fixed, QSizePolicy.Fixed)
        self.archive.archive_cache_status_chip.setTextInteractionFlags(Qt.TextSelectableByMouse)
        self.archive.archive_cache_status_chip.setToolTip("Cache Status: Unknown. Archive cache has not been checked.")
        ...
        menu_corner_layout.addWidget(self.archive.archive_scan_progress_label)
        menu_corner_layout.addWidget(self.archive.archive_scan_progress_bar)
        menu_corner_layout.addSpacing(6)
        menu_corner_layout.addWidget(self.archive.archive_cache_status_chip)
