...
class TextureWorkflowConfigCollectionMixin:
    ...
    def collect_config(self) -> AppConfig:
        ...
        return AppConfig(
            ...
            archive_package_root=self.archive.archive_package_root_edit.text().strip(),
            archive_extract_root=self.archive.archive_extract_root_edit.text().strip(),
            archive_filter_text=self.archive.archive_filter_edit.text().strip(),
            archive_exclude_filter_text=self.archive.archive_exclude_filter_edit.text().strip(),
            archive_extension_filter=self._combo_value(self.archive.archive_extension_filter_combo),
            archive_package_filter_text=self.archive.archive_package_filter_edit.text().strip(),
            archive_structure_filter=self.archive._current_archive_structure_filter_value(),
            archive_role_filter=self._combo_value(self.archive.archive_role_filter_combo),
            archive_exclude_common_technical_suffixes=self.archive.archive_exclude_common_technical_checkbox.isChecked(),
            archive_min_size_kb=self.archive.archive_min_size_spin.value(),
            archive_previewable_only=self.archive.archive_previewable_only_checkbox.isChecked(),
            archive_browser_view_mode=self.archive._archive_browser_view_mode(),
        )
