...
def _clone_submesh_fast(submesh: SubMesh) -> SubMesh:
    cloned = SubMesh(
        ...
        source_vertex_map_authority=str(submesh.source_vertex_map_authority or ""),
        source_bone_palette=tuple(submesh.source_bone_palette or ()),
        source_skin_weight_layout=str(submesh.source_skin_weight_layout or ""),
