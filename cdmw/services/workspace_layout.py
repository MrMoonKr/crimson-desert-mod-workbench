...
LEGACY_WORKSPACE_DIRS: Mapping[str, str] = {
    "input_dds": "sources/original_dds",
    ...
    "archive_extract": "extracts/archive",
    "texture_editor_workspace": "projects/texture_editor",
    "item_icon_library": "libraries/item_icons",
    "model_catalogue": "libraries/models",
    "paa_research": "research/paa",
    "modify_original_sessions": "sessions/modify_original",
...
def workspace_paths(app_root: Path) -> dict[str, Path]:
    ...
    return {
        "workspace_root": root,
        "original_dds_root": root / "sources" / "original_dds",
        ...
        "archive_extract_root": root / "extracts" / "archive",
        "texture_editor_workspace_root": root / "projects" / "texture_editor",
        "item_icon_library_root": root / "libraries" / "item_icons",
        "model_catalogue_root": root / "libraries" / "models",
        "paa_research_root": root / "research" / "paa",
        "modify_original_sessions_root": root / "sessions" / "modify_original",
        "archive_cache_root": root / "cache" / "archive",
        "crash_reports_dir": root / "logs" / "crash_reports",
